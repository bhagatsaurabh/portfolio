  ...
  return (
    <div className={styles.Experience}>
      <div className={styles.Container}>
        ...
        >
          <div ref={(el) => el && (refs.current[0] = el)} className={styles.Content}>
            <h2>Modernization</h2>
            <span>
        ...
        <div
          ...
          className={[styles.Set, expand ? styles.Expand : ""].join(" ")}
        >
          <div ref={(el) => el && (refs.current[2] = el)} className={styles.Content}>
            <h2>Automation</h2>
            <span>
        ...
        <div
          ...
          className={[styles.Set, expand ? styles.Expand : ""].join(" ")}
        >
          <div ref={(el) => el && (refs.current[3] = el)} className={styles.Content}>
        ...
        <div
          ...
          className={[styles.Set, expand ? styles.Expand : ""].join(" ")}
        >
          <div ref={(el) => el && (refs.current[4] = el)} className={styles.Content}>
        ...
        <div
          ...
          className={[styles.Set, expand ? styles.Expand : ""].join(" ")}
        >
          <div ref={(el) => el && (refs.current[5] = el)} className={styles.Content}>
            <h2>DevOps</h2>
            <span>
        ...
        <div
          ...
          className={[styles.Set, expand ? styles.Expand : ""].join(" ")}
        >
          <div ref={(el) => el && (refs.current[6] = el)} className={styles.Content}>
