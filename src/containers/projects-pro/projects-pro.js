...
import classes from './projects-pro.module.css';
...
class ProjectsPro extends Component {
  state = {
    tags: {},
    groupBy: null,
    sortDir: true,
  ...
  render() {
    ...
    return (
      <div className={classes.ProjectsPro}>
...
const mapStateToProps = state => {
  return {
    projectMeta: state.projectsPro.projectMeta,
    projects: state.projectsPro.projects
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(ProjectsPro);